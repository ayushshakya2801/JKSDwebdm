...
const Review = () => {
    const settings = {
        ...
        appendDots: dots => (
            <div>
                <ul className="flex justify-center ml-14 mb-4">{dots}</ul>
            </div>
        ),
  ...
  return (
    ...
    <div className='w-full max-w-[1500px]  mx-auto mb-5'>

    <h1 className=' md:text-5xl text-[#ffa75c] text-center pt-10 font-bold text-2xl'>Our Happy Customers and Students</h1>
               ...
               {data.map((d, index)=>(
                ...
                className='w-1/3 rounded-lg m-6 mx-6 sm:mx-4 md:mx-2 lg:mx-6'>
                    ...
                    <div className='pt-2 md:p-8 text-xl'>
                        <p className='text-center text-sm md:text-xl'>{d.review}</p>                      
                    </div>
                    <div className='  '>
                        
                        <div className=''>
                        <p className='text-2xl md:text-4xl italic text-center font-sans font-semibold pt-2'>{d.Name}</p>
